...
<?php include "includes/header.php"; ?>
	<section id="container">
        ...
        <a href="registro_usuario.php" class="btn_new"> <i class="fas fa-users"></i> Crear usuario</a>
        ...
        <table>
            ...
            $query = mysqli_query($conection, "SELECT u.idusuario, u.nombre, u.correo, u.usuario,
            r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol WHERE estatus = 1 ORDER BY u.idusuario ASC LIMIT $desde,$por_pagina");
