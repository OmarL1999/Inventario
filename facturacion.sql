...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-09-2020 a las 08:19:17
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `procesar_venta` (IN `cod_usuario` INT, IN `cod_cliente` INT, IN `token` VARCHAR(50))  BEGIN
        ...
        CREATE TEMPORARY TABLE tbl_tmp_tokenuser (
         ...
         IF registros > 0 THEN
           ...
           INSERT INTO factura(usuario,codcliente) VALUES (codusuario,cod_cliente);
...
(1, 123456, 'Pedro', 123, 'Manta', '2020-09-16 08:53:22', 0, 1);
...
(1, '445566446', 'JC COMERCIAL.', '', 4454534, 'jccomercial@hotmail.com', 'Los Esteros, Manta', '12.00'),
(2, '12313', 'FABRIL S.A', 'VENTA DE PRODUCTO PRIMERA NECESIDAD', 946464, 'fabril@gmail.com', 'Manta - Montecristi', '12.00');
...
(24, 1, '2020-09-16 08:54:52', 10, '1.00', 0),
(25, 2, '2020-09-16 20:23:30', 100, '1.00', 0);
...
(1, 'Pepsi', 1, '1.00', 10, '2020-09-16 08:54:52', 0, 1, 'img_fc399ac955f656542068c012bcce348b.jpg'),
(2, 'Mantequilla', 1, '1.00', 100, '2020-09-16 20:23:30', 0, 1, 'img_a7bce4fe910ae6714c9428d3b4943d90.jpg');
...
(1, 'FABRIL S.A', 'Omar ikon', 1234, 'Montecristi', '2020-09-16 08:53:44', 0, 1);
...
(1, 'Joao Marrasquin', 'joaomarrasquin@hotmail.com', 'joao', '202cb962ac59075b964b07152d234b70', 1, 1),
(2, 'Juanito', 'jua@gmail.com', 'juanito', '202cb962ac59075b964b07152d234b70', 3, 1);
...
--
ALTER TABLE `detalle_temp`
  MODIFY `correlativo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;
